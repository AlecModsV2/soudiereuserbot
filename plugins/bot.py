...
• `{i}ping`
    Check how fast is my response time.
...
buttons = [
    [
        Button.url(get_string("bot_3"), "https://github.com/Soudiere"),
        Button.url(get_string("bot_4"), "t.me/SoudiereUpdates"),
    ]
]
...
in_alive = "{}\n\n♻️ <b>Soudiere Version -><b> <code>{}</code>\n♻️ <b>SoudierPy -></b> <code>{}</code>\n♻️ <b>Python -></b> <code>{}</code>\n♻️ <b>Uptime -></b> <code>{}</code>\n♻️ <b>Branch -></b> [ {} ]\n\n• <b>Join @ApiSites</b>"
